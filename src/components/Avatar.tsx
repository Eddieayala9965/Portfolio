...
const Avatar = ({ image, className }: AvatarProps) => {
  ...
  return (
    <div ref={component} className={clsx("relative h-full w-full", className)}>
      <div className="avatar aspect-square overflow-hidden rounded-full border-2 border-slate-700 opacity-0">
        <PrismicNextImage
          field={image}
          className="row-start-1 max-w-sm md:col-start-2 md:row-end-3 border-radius-50%"
